...
<body>
    ...
    <jsp:include page="/shared/_menu.jsp"></jsp:include>
    	...
    	<div><h4>User List</h3></div>
    	<p><a href="<%=request.getContextPath()%>/users/create">Create New</a></p>
    		<table class="mdl-data-table mdl-js-data-table mdl-data-table--selectable mdl-shadow--2dp">
              ...
              <c:forEach items = "${users}" var="user">
                  <tr>
                    ...
                    <td><a href="<%=request.getContextPath()%>/users/edit?id=${user.id}">Edit</a> | <a href="<%=request.getContextPath()%>/users/delete?id=${user.id}">Delete</a></td>
                  </tr>
              </c:forEach>
              </tbody>
            </table>
